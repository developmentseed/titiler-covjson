...
(`0001-title.md`, `0002-title.md`, ...), assigned in the order they are accepted,
regardless of topic. The number is permanent: a superseded ADR keeps its file and
number and is marked `Superseded by ADR-NNNN` rather than deleted or renumbered.
