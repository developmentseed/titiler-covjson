...
The geometry a variant is sampled over (a position, a polygon) is a value from
:mod:`titiler_covjson.geometry`, which owns its own invariants; the variants
here pair one with the data read over it.
